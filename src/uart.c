...
#define UART_BAUDRATE_VAL_9600		59					//!< Wert für USART Baud Rate Generator register fuer 9k6
...
bool result = true;										// Optimist
	...
	LPC_SWM->PINASSIGN[0]	= (LPC_SWM->PINASSIGN[0] & 0xFFFFFF00) | ( UART_TXD_PIN <<  0);	/* Pinbelegung fuer U0_TXD */
	LPC_SWM->PINASSIGN[0]	= (LPC_SWM->PINASSIGN[0] & 0xFFFF00FF) | ( UART_RXD_PIN <<  8);	/* Pinbelegung fuer U0_RXD */
